        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-white font-weight-bold" style="text-shadow:2px 2px 6px rgba(0,0,0,0.8);">Add Customer</h1>
<p class="mb-4 text-white" style="text-shadow:1px 1px 4px rgba(0,0,0,0.8);">Enter new customer information.</p>
