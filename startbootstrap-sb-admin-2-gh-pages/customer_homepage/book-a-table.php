...
if (isset($_POST['book'])) {
    ...
    $table_sql = "SELECT * FROM restaurant_table
...
<head>
  ...
  <title>Book a Table — Spice Haven</title>
...
<body>
  ...
  <div class="time-slot-label">Choose an available time slot:</div>

  <div class="time-grid">
    <?php foreach ($time_slots as $slot) { ?>
      <label class="time-slot">
        <input type="radio" name="reservation_time" value="<?php echo $slot; ?>" required>
