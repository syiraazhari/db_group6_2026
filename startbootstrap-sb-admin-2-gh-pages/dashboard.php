...
<head>
    ...
    <title>Restaurant Booking & Reservation System</title>
...
<style>
.bg-gradient-primary {
    background: linear-gradient(180deg, #111111, #2b1d0e) !important;
}
...
">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-4">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Tables
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Total Payments</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">RM150.00</div>
                                        </div>
                                        <div class="col-auto">
    ...
    <div class="card-body">
        <p>View and manage the latest reservation records in the Reservation Management module.</p>
        <a href="reservation_management.php" class="btn btn-primary">
            View Reservations
        </a>
    </div>
</div>
