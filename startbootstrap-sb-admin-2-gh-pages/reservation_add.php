...
if (isset($_POST['save'])) {
    ...
    $sql = "INSERT INTO reservation
            (customer_id, table_id, staff_id, reservation_date, reservation_time, number_of_guests, reservation_status, booking_date)
            VALUES
            ('$customer_id', '$table_id', '$staff_id', '$reservation_date', '$reservation_time', '$number_of_guests', '$reservation_status', '$booking_date')";

    mysqli_query($conn, $sql);

    $updateTable = "UPDATE restaurant_table SET table_status='Reserved' WHERE table_id='$table_id'";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-white font-weight-bold" style="text-shadow:2px 2px 6px rgba(0,0,0,0.8);">Add Reservation</h1>
<p class="mb-4 text-white" style="text-shadow:1px 1px 4px rgba(0,0,0,0.8);">Enter new reservation information.</p>
    ...
    <div class="card-body">
        <form method="POST" action="">
            ...
            <button type="submit" name="save" class="btn btn-success">Save Reservation</button>
